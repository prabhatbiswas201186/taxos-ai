...
def list_modules():
    return {
        "modules": [
            {"id": "tax", "name": "Personal Tax AI", "icon": "🧾", "description": "Regime optimizer, deductions finder", "status": "active"},
            {"id": "gst", "name": "GST AI", "icon": "💸", "description": "ITC reconciliation, filing prep", "status": "active"},
            {"id": "compliance", "name": "Compliance AI", "icon": "🛡️", "description": "Auto tracking, alerts", "status": "active"},
            {"id": "cfo", "name": "AI CFO", "icon": "📈", "description": "Cash flow forecasting", "status": "active"},
            {"id": "audit", "name": "AI Auditor", "icon": "🔍", "description": "Risk scoring, findings", "status": "active"},
            {"id": "business", "name": "Business Consultant", "icon": "💼", "description": "Strategy, growth", "status": "active"},
            {"id": "fraud", "name": "Fraud Detection", "icon": "🚨", "description": "Vendor, invoice, expense", "status": "active"},
            {"id": "legal", "name": "AI Legal Compliance", "icon": "⚖️", "description": "Contracts, licenses", "status": "active"},
            {"id": "hr", "name": "AI HR Compliance", "icon": "👥", "description": "PF, ESI, labor law", "status": "active"},
            {"id": "fundraising", "name": "AI Fundraising Advisor", "icon": "💰", "description": "Investor reports", "status": "active"},
            {"id": "health", "name": "AI Business Health", "icon": "❤️", "description": "6-score health engine", "status": "active"},
            {"id": "collections", "name": "AI Collections Agent", "icon": "📬", "description": "Receivables, reminders", "status": "active"},
            {"id": "procurement", "name": "AI Procurement", "icon": "🛒", "description": "Vendor optimization", "status": "active"},
            {"id": "benefits", "name": "Government Benefits", "icon": "🏛️", "description": "Subsidies, incentives", "status": "active"},
            {"id": "global", "name": "AI Global Expansion", "icon": "🌍", "description": "Jurisdiction advisor", "status": "active"},
            {"id": "chat", "name": "AI Chat / CFO", "icon": "💬", "description": "Natural language queries", "status": "active"},
            {"id": "statements", "name": "Financial Statements", "icon": "📊", "description": "P&L, BS, CF auto-gen", "status": "active"},
        ]
    }
